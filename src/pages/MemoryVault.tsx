  ...
  const [moments, setMoments] = useState<VaultMoment[]>([
    {
      ...
      description: 'Natural lighting at the park worked perfectly!',
      content: {},
      notes: '',
      tags: ['profile', 'photos'],
      is_favorite: false,
    ...
    },
    {
      ...
      description: 'If they only talk about themselves, move on.',
      content: {},
    ...
    },
    {
      ...
      title: 'Great first coffee date',
      description: 'No awkward silences, loved the same documentaries.',
      content: {},
    ...
    },
    {
      ...
      description: 'Week off helped me refocus on what I actually want.',
      content: {},
    ...
    },
    {
      id: '5',
      moment_type: 'reflection',
      title: 'I have a type apparently',
      description: 'Keep matching with creative people.',
      content: {},
      notes: '',
